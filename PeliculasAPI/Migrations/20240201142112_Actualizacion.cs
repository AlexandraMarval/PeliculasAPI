    ...
    public partial class Actualizacion : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(1948, 12, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Samuel L. Jackson" },
                    { 2, new DateTime(1996, 6, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Tom Holland" },
                    { 7, new DateTime(1975, 6, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Tobey Maguire" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Peliculas",
                columns: new[] { "Id", "EnCine", "FechaEstreno", "Poster", "Titulo" },
                values: new object[] { 1, true, new DateTime(2019, 6, 28, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "SPIDER-MAN: NO WAY HOME" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 4, "Cines Unidos", (NetTopologySuite.Geometries.Point)new NetTopologySuite.IO.WKTReader().Read("SRID=4326;POINT (-66.917333 10.504223)") },
                    { 5, "Cinex", (NetTopologySuite.Geometries.Point)new NetTopologySuite.IO.WKTReader().Read("SRID=4326;POINT (-66.8773 10.504223)") },
                    { 6, "Cines Aragonia", (NetTopologySuite.Geometries.Point)new NetTopologySuite.IO.WKTReader().Read("SRID=4326;POINT (-0.908871 41.639305)") }
                });
